...
@section("title", "Dados e Estatísticas")

@section('content')
<script>
document.getElementById("menu-item-inicio").className += " active";
</script>
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-around align-items-center flex-wrap">
                ...
                <span class="align-middle text-muted">Última Milha</span>
                <div class="d-flex">
    ...
    <div class="row">
                ...
                <div class="card-body pt-1">
                    <div class="d-flex activity-content">
                        ...
                        <div class="activity-progress flex-grow-1">
                            <small class="text-muted d-inline-block mb-50">Clientes</small>
                            <small class="float-right">{{ $clientes }}</small>
                            <div class="progress progress-bar-primary progress-sm">
                                <div class="progress-bar" role="progressbar" aria-valuenow="50" style="width:{{ $clientesPorce }}%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex activity-content">
                        ...
                        <div class="activity-progress flex-grow-1">
                            <small class="text-muted d-inline-block mb-50">Cidades</small>
                            <small class="float-right">{{ $cidades }}</small>
                            <div class="progress progress-bar-success progress-sm">
                                <div class="progress-bar" role="progressbar" aria-valuenow="80" style="width:{{ $cidadesPorce }}%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex activity-content">
                        ...
                        <div class="activity-progress flex-grow-1">
                            <small class="text-muted d-inline-block mb-50">Última Milha</small>
                            <small class="float-right">{{ $ultimas }}</small>
                            <div class="progress progress-bar-warning progress-sm">
                                <div class="progress-bar" role="progressbar" aria-valuenow="60" style="width:{{ $ultimasPorce }}%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex mb-75">
                        ...
                        <div class="activity-progress flex-grow-1">
                            <small class="text-muted d-inline-block mb-50">Site</small>
                            <small class="float-right">{{ $sites }}</small>
                            <div class="progress progress-bar-danger progress-sm">
                                <div class="progress-bar" role="progressbar" aria-valuenow="30" style="width:{{ $sitesPorce }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6 col-12 profit-report-card">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                    <h4 class="card-title">Último IP cadastrado</h4>
                    </div>
                    <div class="card-body">
                    <div class="d-flex align-items-end justify-content-around">
                        <div class="registration-content mr-xl-1">
                        <h4 class="mb-0">{{ $faixas }}</h4>
                        <i class="bx bx-trending-up success align-middle"></i>
                        <span class="text-success">{{ $somas }}</span>
                        </div>
                    </div>
                </div>
        </div>
